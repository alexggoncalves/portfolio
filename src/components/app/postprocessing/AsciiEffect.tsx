    ...
    (
        {
            ...
            atlasGridSize: Vector2;
            gridSize: Vector2;
            asciiUITexture: Texture | null;
            layoutRenderTarget: Texture | null;
        },
        ref,
    ) => {
        ...
        useFrame(() => {
            ...
            if (ui) ui.value = asciiUITexture;
            if (bg) bg.value = layoutRenderTarget;

            // asciiUITexture.dispose();
            // layoutRenderTarget.dispose();
        }, 2);
