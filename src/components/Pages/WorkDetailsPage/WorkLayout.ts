...
import { CanvasText } from "../../PageRenderer/Elements/CanvasText";
...
export class WorkLayout extends Layer {
    ...
    placeVideo(): void {
        const src =
            "https://cloud.alexgg.com/endless-purrs/endless-purrs-1.png"; // TEMP
        ...
        this.placementPosition.y += gridSize.y;
        this.layoutSize.y += gridSize.y;
        this.elements.push(block);
    }
