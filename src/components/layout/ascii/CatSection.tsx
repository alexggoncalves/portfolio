...
function CatSection() {
    ...
    const pageCoords = {
        ...
        y: AsciiRenderConfig.gridSize.y * 2,
    };
    ...
    const updatePosition = (elapsed: number) => {
        ...
        // Base Cat position
        sectionRef.current.position.set(sectionWorldPos.x,sectionWorldPos.y,0);
        // sectionRef.current.position.y += scroll.offset
